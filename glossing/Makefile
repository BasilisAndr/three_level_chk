...
pkgdatadir = $(datadir)/chkchn
pkgincludedir = $(includedir)/chkchn
pkglibdir = $(libdir)/chkchn
pkglibexecdir = $(libexecdir)/chkchn
...
am__installdirs = "$(DESTDIR)$(chkchndir)"
DATA = $(chkchn_DATA)
...
ACLOCAL = ${SHELL} /Users/Basilis/Documents/Langs/A/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /Users/Basilis/Documents/Langs/A/missing autoconf
AUTOHEADER = ${SHELL} /Users/Basilis/Documents/Langs/A/missing autoheader
AUTOMAKE = ${SHELL} /Users/Basilis/Documents/Langs/A/missing automake-1.16
AWK = gawk
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"chkchn\" -DPACKAGE_TARNAME=\"chkchn\" -DPACKAGE_VERSION=\"0.1.0\" -DPACKAGE_STRING=\"chkchn\ 0.1.0\" -DPACKAGE_BUGREPORT=\"francis.tyers@uit.no\" -DPACKAGE_URL=\"\"
ECHO_C = \c
ECHO_N =
ECHO_T =
...
LN_S = ln -s
LTLIBOBJS =
MAKEINFO = ${SHELL} /Users/Basilis/Documents/Langs/A/missing makeinfo
MKDIR_P = /usr/local/bin/gmkdir -p
PACKAGE = chkchn
PACKAGE_BUGREPORT = francis.tyers@uit.no
PACKAGE_NAME = chkchn
PACKAGE_STRING = chkchn 0.1.0
PACKAGE_TARNAME = chkchn
PACKAGE_URL =
...
STRIP =
VERSION = 0.1.0
abs_builddir = /Users/Basilis/Documents/Langs/A
abs_srcdir = /Users/Basilis/Documents/Langs/A
abs_top_builddir = /Users/Basilis/Documents/Langs/A
abs_top_srcdir = /Users/Basilis/Documents/Langs/A
am__leading_dot = .
...
install_sh = ${SHELL} /Users/Basilis/Documents/Langs/A/install-sh
...
$(am__aclocal_m4_deps):
install-chkchnDATA: $(chkchn_DATA)
	@$(NORMAL_INSTALL)
	@list='$(chkchn_DATA)'; test -n "$(chkchndir)" || list=; \
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(chkchndir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(chkchndir)" || exit 1; \
	fi; \
	for p in $$list; do \
	...
	while read files; do \
	  echo " $(INSTALL_DATA) $$files '$(DESTDIR)$(chkchndir)'"; \
	  $(INSTALL_DATA) $$files "$(DESTDIR)$(chkchndir)" || exit $$?; \
	done

uninstall-chkchnDATA:
	@$(NORMAL_UNINSTALL)
	@list='$(chkchn_DATA)'; test -n "$(chkchndir)" || list=; \
	files=`for p in $$list; do echo $$p; done | sed -e 's|^.*/||'`; \
	dir='$(DESTDIR)$(chkchndir)'; $(am__uninstall_files_from_dir)
tags TAGS:
...
installdirs:
	for dir in "$(DESTDIR)$(chkchndir)"; do \
...
install-data-am: install-chkchnDATA
...
uninstall-am: uninstall-chkchnDATA
...
.PHONY: all all-am am--refresh check check-am clean clean-generic \
	...
	install install-am install-chkchnDATA install-data \
...
clear:
	rm $(LANG1).lexc $(LANG1).lexc.hfst $(LANG1).lexctwol.hfst $(LANG1).lexctwol.mor.hfst
	rm $(LANG1).mor.hfst $(LANG1).gen.hfst $(LANG1).mor.hfstol $(LANG1).gen.hfstol
###############################################################################
